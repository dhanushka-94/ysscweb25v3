...
@section('title', 'News - Young Silver Sports Club')
@section('description', 'Stay updated with the latest news from Young Silver Sports Club. Get the latest updates on matches, events, and club activities.')
@section('keywords', 'Young Silver Sports Club news, YSSC news, football club news, Colombo football news, Wellawatte sports news, Sri Lanka football news, latest news, club updates')
@section('og_title', 'News - Young Silver Sports Club')
@section('og_description', 'Stay updated with the latest news from Young Silver Sports Club. Get the latest updates on matches, events, and club activities.')
@section('og_type', 'website')
@section('twitter_title', 'News - Young Silver Sports Club')
@section('twitter_description', 'Stay updated with the latest news from Young Silver Sports Club. Get the latest updates on matches, events, and club activities.')
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <!-- Facebook Share -->
                                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('news.show', $article->slug)) }}&quote={{ urlencode($article->title) }}" 
                                           target="_blank" 
                                        ...
                                        <!-- Twitter Share -->
                                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('news.show', $article->slug)) }}&text={{ urlencode($article->title) }}" 
                                           target="_blank" 
                                           rel="noopener noreferrer"
                                        ...
                                        <!-- WhatsApp Share -->
                                        <a href="https://wa.me/?text={{ urlencode($article->title . ' - ' . route('news.show', $article->slug)) }}" 
                                           target="_blank" 
                                           rel="noopener noreferrer"
