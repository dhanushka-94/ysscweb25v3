...
@section('title', 'View Application - Admin')
...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-4">
            ...
            <a href="{{ route('admin.member-applications.edit', $memberApplication) }}" class="bg-yellow-400 text-gray-900 px-4 py-2 rounded-lg hover:bg-yellow-500 transition">
                Edit Application
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-6">
                    ...
                    <p class="text-gray-900">{{ $memberApplication->address }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Full Name</label>
                        <p class="text-gray-900">{{ $memberApplication->guardian_full_name }}</p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">NIC</label>
                        <p class="text-gray-900">{{ $memberApplication->formatted_guardian_nic }}</p>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Contact Number 1</label>
                        <p class="text-gray-900">{{ $memberApplication->formatted_guardian_contact_number_1 }}</p>
                    </div>
                    
                    @if($memberApplication->guardian_contact_number_2)
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Contact Number 2</label>
                        <p class="text-gray-900">{{ $memberApplication->guardian_contact_number_2 }}</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="mt-6">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Address</label>
                    <p class="text-gray-900">{{ $memberApplication->guardian_address }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <img src="{{ asset('storage/' . $memberApplication->profile_photo) }}" alt="Profile Photo" class="w-full h-64 object-cover rounded-lg">
            </div>
            @else
            <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Profile Photo</h3>
                <div class="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                    <div class="text-center">
                        <div class="w-20 h-20 bg-gray-300 rounded-full flex items-center justify-center mx-auto mb-4">
                            <span class="text-2xl font-bold text-gray-600">{{ substr($memberApplication->full_name, 0, 1) }}</span>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="text-sm text-gray-600">
                    <p><strong>Applied:</strong> {{ $memberApplication->created_at->format('M d, Y g:i A') }}</p>
                    @if($memberApplication->updated_at != $memberApplication->created_at)
                        <p><strong>Last Updated:</strong> {{ $memberApplication->updated_at->format('M d, Y g:i A') }}</p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    @if($memberApplication->status === 'pending')
                        <form action="{{ route('admin.member-applications.approve', $memberApplication) }}" method="POST">
                            @csrf
                    ...
                    <a href="{{ route('admin.member-applications.edit', $memberApplication) }}" class="block w-full bg-yellow-400 text-gray-900 px-4 py-2 rounded-lg hover:bg-yellow-500 transition text-center">
                        Edit Application
                    </a>
                </div>
            </div>
            ...
            <!-- Notes -->
            @if($memberApplication->notes || $memberApplication->rejection_reason)
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-900 bg-gray-50 p-3 rounded">{{ $memberApplication->notes }}</p>
                </div>
                @endif
                ...
                <div>
                    ...
                    <p class="text-gray-900 bg-red-50 p-3 rounded">{{ $memberApplication->rejection_reason }}</p>
                </div>
                @endif
            </div>
            @endif
...
<div id="rejectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            <form action="{{ route('admin.member-applications.reject', $memberApplication) }}" method="POST">
                @csrf
                <div class="p-6">
