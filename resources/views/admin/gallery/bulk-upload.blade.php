                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        <strong>Server Configuration:</strong> If you encounter upload errors, please ensure your server has the following settings: post_max_size ≥ 200M, upload_max_filesize ≥ 200M, max_execution_time ≥ 900s, memory_limit ≥ 1024M.
                                    </p>
                                </div>
                            </div>
                        </div>
