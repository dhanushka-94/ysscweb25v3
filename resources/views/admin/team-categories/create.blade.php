...
<head>
    ...
    <title>Add Team Category - Admin - YSSC Football Club</title>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-6">Add Team Category</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <input type="color" id="color" name="color" value="{{ old('color', '#facc15') }}" required
                                ...
                                <input type="text" id="color_text" value="{{ old('color', '#facc15') }}" 
