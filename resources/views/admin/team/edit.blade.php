...
<head>
    ...
    <title>Edit Team Member - Admin - YSSC Football Club</title>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="jersey_number" name="jersey_number"
                                    ...
                                    value="{{ old('jersey_number', $team->jersey_number) }}">
                                @error('jersey_number')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nationality" name="nationality"
                                    ...
                                    value="{{ old('nationality', $team->nationality) }}">
                                @error('nationality')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <textarea id="bio" name="bio" rows="4"
                                class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none @error('bio') border-red-500 @enderror">{{ old('bio', $team->bio) }}</textarea>
                            @error('bio')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
