...
<head>
    ...
    <title>Add Fixture - Admin - YSSC Football Club</title>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-6">Add Fixture</h1>
                ...
                <form action="{{ route('admin.fixtures.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="competition" name="competition" placeholder="e.g. Premier League, FA Cup"
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
