...
<head>
    ...
    <title>Add Sponsor - Admin - YSSC Football Club</title>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-6">Add New Sponsor</h1>
                ...
                <form action="{{ route('admin.sponsors.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="logo" class="block text-sm font-semibold text-gray-700 mb-2">Logo (PNG with transparent background recommended)</label>
