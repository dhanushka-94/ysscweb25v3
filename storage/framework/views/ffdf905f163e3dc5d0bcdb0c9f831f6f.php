                        ...
                        <div class="border-b pb-6">
                            ...
                            <?php if($settings['site_logo']): ?>
                                <div class="mb-4 flex items-start space-x-4">
                                    <img src="<?php echo e(asset('storage/' . $settings['site_logo'])); ?>" alt="Current Logo" class="h-20 w-auto object-contain border border-gray-200 rounded p-2">
                                    <div>
                            ...
                            <div>
                                ...
                                <input type="file" id="site_logo" name="site_logo" accept="image/*"
                                    class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none <?php $__errorArgs = ['site_logo'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="site_name" name="site_name" required
                                class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none <?php $__errorArgs = ['site_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="site_tagline" name="site_tagline"
                                class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none <?php $__errorArgs = ['site_tagline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 bg-white rounded-lg shadow p-8">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="<?php echo e(route('admin.team-categories.index')); ?>" class="bg-yellow-400 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 flex items-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="flex items-center space-x-3 mb-3">
                                <div class="w-4 h-4 rounded-full border-2 border-gray-300" style="background-color: <?php echo e($category->color); ?>"></div>
                                <h3 class="font-semibold text-gray-900"><?php echo e($category->name); ?></h3>
                            </div>
                            <?php if($category->description): ?>
                                <p class="text-sm text-gray-600 mb-2"><?php echo e(Str::limit($category->description, 60)); ?></p>
                            <?php endif; ?>
                            <div class="flex items-center justify-between text-sm text-gray-500">
                                <span><?php echo e($category->teams_count); ?> members</span>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="col-span-full text-center py-8 text-gray-500">
                            ...
                            <a href="<?php echo e(route('admin.team-categories.create')); ?>" class="text-yellow-600 hover:text-yellow-700 mt-2 inline-block">
                ...
                <?php if($categories->count() >= 6): ?>
                    <div class="mt-4 text-center">
                        <a href="<?php echo e(route('admin.team-categories.index')); ?>" class="text-yellow-600 hover:text-yellow-700 text-sm font-medium">
                            View all <?php echo e(\App\Models\TeamCategory::count()); ?> categories →
                        </a>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <form id="deleteLogoForm" action="<?php echo e(route('admin.settings.delete-logo')); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>