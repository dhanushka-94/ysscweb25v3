...
<?php $__env->startSection('title', 'Application Submitted - Young Silver Sports Club'); ?>
<?php $__env->startSection('description', 'Your membership application has been successfully submitted to Young Silver Sports Club.'); ?>
<?php $__env->startSection('keywords', 'application submitted, membership application, Young Silver Sports Club'); ?>
<?php $__env->startSection('og_title', 'Application Submitted - Young Silver Sports Club'); ?>
<?php $__env->startSection('og_description', 'Your membership application has been successfully submitted to Young Silver Sports Club.'); ?>
<?php $__env->startSection('og_type', 'website'); ?>
<?php $__env->startSection('twitter_title', 'Application Submitted - Young Silver Sports Club'); ?>
<?php $__env->startSection('twitter_description', 'Your membership application has been successfully submitted to Young Silver Sports Club.'); ?>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-gray-50 rounded-lg p-8 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-900 font-mono"><?php echo e($memberApplication->reference_number ?: 'YSSC/' . date('Y') . '/0001'); ?></p>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700 mb-2">Submitted On</h3>
                            <p class="text-gray-900"><?php echo e($memberApplication->created_at->format('F j, Y \a\t g:i A')); ?></p>
                        </div>
                        <div>
                ...
                <div class="bg-yellow-50 rounded-lg p-8 mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="<?php echo e(route('member-application.pdf', $memberApplication->id)); ?>" 
                        ...
                        <a href="<?php echo e(route('member-application.index')); ?>" 
                ...
                <div class="bg-gray-100 rounded-lg p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-700 mb-2">Application Reference</h3>
                            <p class="text-gray-900 font-mono text-lg"><?php echo e($memberApplication->reference_number ?: 'YSSC/' . date('Y') . '/0001'); ?></p>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/member-application/complete.blade.php ENDPATH**/ ?>