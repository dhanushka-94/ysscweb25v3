                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                <?php if($member->category): ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium" style="background-color: <?php echo e($member->category->color); ?>20; color: <?php echo e($member->category->color); ?>;">
                                        <?php echo e($member->category->name); ?>
