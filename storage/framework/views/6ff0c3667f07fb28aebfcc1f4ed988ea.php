...
<?php $__env->startSection('title', 'Join Us - Young Silver Sports Club'); ?>
<?php $__env->startSection('description', 'Join Young Silver Sports Club and become part of our football community. Apply for membership and be part of our team.'); ?>
<?php $__env->startSection('keywords', 'join YSSC, membership application, Young Silver Sports Club membership, football club join, Sri Lanka football'); ?>
<?php $__env->startSection('og_title', 'Join Us - Young Silver Sports Club'); ?>
<?php $__env->startSection('og_description', 'Join Young Silver Sports Club and become part of our football community. Apply for membership and be part of our team.'); ?>
<?php $__env->startSection('og_type', 'website'); ?>
<?php $__env->startSection('twitter_title', 'Join Us - Young Silver Sports Club'); ?>
<?php $__env->startSection('twitter_description', 'Join Young Silver Sports Club and become part of our football community. Apply for membership and be part of our team.'); ?>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div class="bg-gray-50 rounded-lg p-8">
                        ...
                        <div class="mt-8">
                            <a href="<?php echo e(route('member-application.create')); ?>" class="w-full bg-yellow-400 text-gray-900 px-6 py-4 rounded-lg font-bold text-lg hover:bg-yellow-500 transition text-center block">
                                Start Application
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/member-application/index.blade.php ENDPATH**/ ?>