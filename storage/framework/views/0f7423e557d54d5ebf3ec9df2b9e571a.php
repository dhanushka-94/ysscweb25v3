                ...
                <?php $__currentLoopData = $groupedImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryTitle => $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
                            ...
                            <?php $__currentLoopData = $visibleImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($hasMoreImages): ?>
                                <div class="group relative aspect-square overflow-hidden rounded-lg shadow-md hover:shadow-xl transition cursor-pointer bg-gradient-to-br from-yellow-400 to-yellow-500 flex items-center justify-center" 
                                     onclick="showAllImages('<?php echo e($galleryTitle); ?>', <?php echo e($images->count()); ?>, <?php echo e($remainingCount); ?>)">
                                    <div class="text-center text-gray-900">
                                        <svg class="w-6 h-6 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                                        </svg>
                                        <p class="font-semibold text-sm">View More</p>
                                        <p class="text-xs"><?php echo e($remainingCount); ?> more</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
