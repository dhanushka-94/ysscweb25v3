<?php $__env->startSection('title', 'Arena - Young Silver Sports Club'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            <!-- Arena Image -->
            <div class="mb-12">
                <img src="<?php echo e(asset('images/arena.png')); ?>" alt="Cooray Park Arena" class="rounded-lg shadow-2xl w-full h-auto max-h-[500px] object-cover">
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/about/arena.blade.php ENDPATH**/ ?>