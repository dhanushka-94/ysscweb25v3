        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:space-x-4">
                    ...
                    <a href="<?php echo e(route('admin.team-categories.index')); ?>" class="border-transparent text-gray-500 hover:border-yellow-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        Team Categories
                    </a>
                    ...
                    <a href="<?php echo e(route('admin.member-applications.index')); ?>" class="border-transparent text-gray-500 hover:border-yellow-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        Applications
                    </a>
                </div>
            </div>
