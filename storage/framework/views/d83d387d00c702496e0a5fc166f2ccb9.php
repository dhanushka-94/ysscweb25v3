...
<?php $__env->startSection('title', 'Edit Application - Admin'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-4">
            ...
            <a href="<?php echo e(route('admin.member-applications.show', $memberApplication)); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                View Application
            </a>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('admin.member-applications.update', $memberApplication)); ?>" method="POST" class="space-y-8">
        <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="full_name" name="full_name" value="<?php echo e(old('full_name', $memberApplication->full_name)); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email', $memberApplication->email)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="nic" name="nic" value="<?php echo e(old('nic', $memberApplication->nic)); ?>" required maxlength="12" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="123456789V or 123456789012">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" id="contact_number_1" name="contact_number_1" value="<?php echo e(old('contact_number_1', $memberApplication->contact_number_1)); ?>" required pattern="0[0-9]{9}" maxlength="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" id="contact_number_2" name="contact_number_2" value="<?php echo e(old('contact_number_2', $memberApplication->contact_number_2)); ?>" pattern="0[0-9]{9}" maxlength="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"><?php echo e(old('address', $memberApplication->address)); ?></textarea>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="guardian_full_name" name="guardian_full_name" value="<?php echo e(old('guardian_full_name', $memberApplication->guardian_full_name)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        <p class="text-xs text-gray-500 mt-1">Optional</p>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="guardian_nic" name="guardian_nic" value="<?php echo e(old('guardian_nic', $memberApplication->guardian_nic)); ?>" maxlength="12" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="123456789V or 123456789012">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" id="guardian_contact_number_1" name="guardian_contact_number_1" value="<?php echo e(old('guardian_contact_number_1', $memberApplication->guardian_contact_number_1)); ?>" pattern="0[0-9]{9}" maxlength="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel" id="guardian_contact_number_2" name="guardian_contact_number_2" value="<?php echo e(old('guardian_contact_number_2', $memberApplication->guardian_contact_number_2)); ?>" pattern="0[0-9]{9}" maxlength="10" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        <p class="text-xs text-gray-500 mt-1">Format: 0XXXXXXXXX (Optional)</p>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="guardian_address" name="guardian_address" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"><?php echo e(old('guardian_address', $memberApplication->guardian_address)); ?></textarea>
                        <p class="text-xs text-gray-500 mt-1">Optional</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="status" name="status" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
                        <option value="pending" <?php echo e(old('status', $memberApplication->status) === 'pending' ? 'selected' : ''); ?>>Pending</option>
                        <option value="approved" <?php echo e(old('status', $memberApplication->status) === 'approved' ? 'selected' : ''); ?>>Approved</option>
                        <option value="rejected" <?php echo e(old('status', $memberApplication->status) === 'rejected' ? 'selected' : ''); ?>>Rejected</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" placeholder="Add any notes about this application..."><?php echo e(old('notes', $memberApplication->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex justify-end space-x-4">
            <a href="<?php echo e(route('admin.member-applications.show', $memberApplication)); ?>" class="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition">
                Cancel
            </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/admin/member-applications/edit.blade.php ENDPATH**/ ?>