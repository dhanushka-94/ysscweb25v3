...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Young Silver Sports Club - Building Champions of Tomorrow'); ?></title>
    ...
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'Young Silver Sports Club, YSSC, football club, Colombo, Wellawatte, Sri Lanka football, youth football, sports club, football training, Cooray Park, football academy, Sri Lanka sports'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'Young Silver Sports Club - Building Champions of Tomorrow'); ?>">
    ...
    <meta property="og:updated_time" content="<?php echo e(now()->toISOString()); ?>">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', 'Young Silver Sports Club - Building Champions of Tomorrow'); ?>">
        ...
        <nav class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3">
                    ...
                    <?php if($siteLogo): ?>
                        <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="<?php echo e($siteName); ?>" class="h-16 w-auto object-contain mobile-logo">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 mobile-logo-text"><?php echo e($siteName); ?></h1>
                            <?php if($siteTagline): ?>
                                <p class="text-sm text-gray-600 mobile-logo-tagline"><?php echo e($siteTagline); ?></p>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="hidden lg:flex items-center space-x-6">
                        ...
                        <a href="<?php echo e(route('member-application.index')); ?>" class="bg-yellow-400 text-gray-900 hover:bg-yellow-500 px-4 py-2 rounded-lg font-bold transition uppercase shadow-lg">JOIN US</a>
                ...
                <div id="mobile-menu" class="hidden lg:hidden mt-4 pb-4">
                    ...
                    <a href="<?php echo e(route('member-application.index')); ?>" class="block py-3 px-4 bg-yellow-400 text-gray-900 hover:bg-yellow-500 font-bold uppercase rounded-lg mx-2 my-2 shadow-lg">JOIN US</a>
                        ...
                        <div class="news-ticker flex animate-scroll">
                            <?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="news-item flex-shrink-0 mr-8">
                                    <a href="<?php echo e(route('news.show', $news->slug)); ?>" class="hover:text-yellow-600 transition-colors duration-200">
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($news->title); ?></span>
                                    </a>
                                </div>
...
<?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4 mb-6">
                        <?php if($footerLogo): ?>
                            <img src="<?php echo e(asset('storage/' . $footerLogo)); ?>" alt="<?php echo e($footerSiteName); ?>" class="h-20 w-auto object-contain">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <h3 class="text-2xl font-bold text-yellow-400"><?php echo e($footerSiteName); ?></h3>
                            <?php if($footerTagline): ?>
                                <p class="text-sm text-gray-400"><?php echo e($footerTagline); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->isAdmin()): ?>
                                <div class="inline-flex items-center space-x-4">
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-yellow-400 text-gray-900 hover:bg-yellow-500 px-4 py-2 rounded-lg font-semibold transition uppercase">ADMIN DASHBOARD</a>
                                    <form method="POST" action="<?php echo e(route('logout')); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="bg-gray-600 text-white hover:bg-gray-700 px-6 py-2 rounded-lg font-semibold transition uppercase">ADMIN LOGIN</a>
                        <?php endif; ?>
                    </div>
    ...
    <?php if (isset($component)) { $__componentOriginal509376b5b3eacbf9265255ec8b40eb35 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal509376b5b3eacbf9265255ec8b40eb35 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.performance-monitor','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('performance-monitor'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal509376b5b3eacbf9265255ec8b40eb35)): ?>
<?php $attributes = $__attributesOriginal509376b5b3eacbf9265255ec8b40eb35; ?>
<?php unset($__attributesOriginal509376b5b3eacbf9265255ec8b40eb35); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal509376b5b3eacbf9265255ec8b40eb35)): ?>
<?php $component = $__componentOriginal509376b5b3eacbf9265255ec8b40eb35; ?>
<?php unset($__componentOriginal509376b5b3eacbf9265255ec8b40eb35); ?>
<?php endif; ?>
</body>
</html>
