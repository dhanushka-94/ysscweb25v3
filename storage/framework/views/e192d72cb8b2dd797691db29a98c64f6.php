    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-600">Team members will be displayed here once they are added.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<div class="bg-gray-900 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="<?php echo e(route('member-applications.create')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/team/index.blade.php ENDPATH**/ ?>