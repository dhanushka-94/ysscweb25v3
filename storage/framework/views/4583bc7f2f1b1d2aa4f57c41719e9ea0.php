<?php $__env->startSection('title', 'About Club - Young Silver Sports Club'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="mb-12">
                <img src="<?php echo e(asset('images/about_us.jpeg')); ?>" alt="Young Silver Sports Club" class="rounded-lg shadow-2xl w-full h-auto object-contain">
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('member-application.index')); ?>" class="bg-white text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition shadow-lg">
                        Apply for Membership
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="bg-gray-900 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-800 transition shadow-lg">
                        Contact Us
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/about/club.blade.php ENDPATH**/ ?>