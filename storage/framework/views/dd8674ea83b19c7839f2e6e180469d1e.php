                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none transition <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input id="password" type="password" name="password" required autocomplete="current-password"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-yellow-400 focus:outline-none transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-yellow-600 hover:text-yellow-700 font-semibold">
                                Forgot Password?
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <?php if(Route::has('register')): ?>
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-yellow-600 hover:text-yellow-700 font-semibold">
                                Register here
                            </a>
                        </p>
                    </div>
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-white hover:text-gray-900 font-semibold transition">
