<?php $__env->startSection('title', 'Home - Young Silver Sports Club'); ?>
<?php $__env->startSection('description', 'Welcome to Young Silver Sports Club - Premier football club in Wellawatte, Colombo. Building champions of tomorrow since 1967. Join our community for football excellence.'); ?>
<?php $__env->startSection('keywords', 'Young Silver Sports Club, YSSC, football club, Colombo, Wellawatte, Sri Lanka football, youth football, sports club, football training, Cooray Park, football academy, Sri Lanka sports, home'); ?>
<?php $__env->startSection('og_title', 'Young Silver Sports Club - Building Champions of Tomorrow'); ?>
<?php $__env->startSection('og_description', 'Welcome to Young Silver Sports Club - Premier football club in Wellawatte, Colombo. Building champions of tomorrow since 1967.'); ?>
<?php $__env->startSection('og_type', 'website'); ?>
<?php $__env->startSection('twitter_title', 'Young Silver Sports Club - Building Champions of Tomorrow'); ?>
<?php $__env->startSection('twitter_description', 'Welcome to Young Silver Sports Club - Premier football club in Wellawatte, Colombo. Building champions of tomorrow since 1967.'); ?>
    ...
    <section class="relative bg-gray-900" id="heroSlider">
        ...
        <style>
            ...
            <div class="slider-item absolute inset-0 transition-opacity duration-1000 <?php echo e($index === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'); ?>" data-slide="<?php echo e($index); ?>">
                <img src="<?php echo e(asset('storage/' . $slider->image)); ?>" alt="<?php echo e($slider->title); ?>" class="w-full h-full object-cover" loading="eager" data-preload="true">
                <div class="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
                <div class="absolute inset-0 flex items-end pb-8 sm:pb-12 lg:pb-16">
                    <div class="container mx-auto px-4">
                        <div class="max-w-4xl mx-auto text-center text-white">
                            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 animate-fade-in"><?php echo e($slider->title); ?></h1>
                            <?php if($slider->description): ?>
                                <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 animate-fade-in-delay"><?php echo e($slider->description); ?></p>
                            <?php endif; ?>
                            <?php if($slider->button_text && $slider->button_link): ?>
                                <a href="<?php echo e($slider->button_link); ?>" class="inline-block bg-yellow-400 text-gray-900 px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-bold text-sm sm:text-base hover:bg-yellow-500 transition animate-fade-in-delay-2">
        ...
        <div class="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-3 z-20">
            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button class="slider-dot w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all <?php echo e($index === 0 ? 'bg-yellow-400 w-6 sm:w-8' : 'bg-white/50 hover:bg-white/75'); ?>" data-slide="<?php echo e($index); ?>"></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a href="<?php echo e(route('about.club')); ?>" class="bg-gray-900 text-white px-6 py-3 sm:px-8 rounded-lg font-semibold hover:bg-gray-800 transition text-center">
                        About Us
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="bg-white text-gray-900 px-6 py-3 sm:px-8 rounded-lg font-semibold hover:bg-gray-100 transition text-center">
                        Get In Touch
                    </a>
                </div>
            </div>
                                            ...
                                            <div class="text-center flex-1">
                                                <div class="flex flex-col items-center gap-2">
                                                    <?php if($fixture->home_team_logo): ?>
                                                        <img src="<?php echo e(asset('storage/' . $fixture->home_team_logo)); ?>" 
                                                             alt="<?php echo e($fixture->home_team); ?>" 
                                                    ...
                                                    <?php else: ?>
                                                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gray-200 rounded-lg border-2 border-gray-300 flex items-center justify-center">
                                                            <span class="text-gray-500 text-xs font-bold"><?php echo e(substr($fixture->home_team, 0, 2)); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div class="font-bold text-sm sm:text-lg text-center"><?php echo e($fixture->home_team); ?></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center flex-1">
                                                <div class="flex flex-col items-center gap-2">
                                                    <?php if($fixture->away_team_logo): ?>
                                                        <img src="<?php echo e(asset('storage/' . $fixture->away_team_logo)); ?>" 
                                                             alt="<?php echo e($fixture->away_team); ?>" 
                                                             class="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded-lg border-2 border-gray-300">
                                                    <?php else: ?>
                                                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gray-200 rounded-lg border-2 border-gray-300 flex items-center justify-center">
                                                            <span class="text-gray-500 text-xs font-bold"><?php echo e(substr($fixture->away_team, 0, 2)); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div class="font-bold text-sm sm:text-lg text-center"><?php echo e($fixture->away_team); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-col sm:flex-row">
                                            <?php if($news->featured_image): ?>
                                                <div class="w-full sm:w-32 h-32 sm:h-32 news-image-container">
                                                    <img src="<?php echo e(asset('storage/' . $news->featured_image)); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-full object-cover" loading="lazy">
                                                </div>
                                            <?php else: ?>
                                            ...
                                            <div class="p-3 sm:p-4 flex-1">
                                                ...
                                                <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2 line-clamp-2"><?php echo e($news->title); ?></h3>
                                                <?php if($news->excerpt): ?>
                                                    <p class="text-gray-600 text-xs sm:text-sm mb-2 line-clamp-2"><?php echo e(Str::limit($news->excerpt, 60)); ?></p>
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('news.show', $news->slug)); ?>" class="text-yellow-600 font-semibold hover:text-yellow-700 text-xs sm:text-sm">
                                                    Read More →
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4 max-w-6xl mx-auto">
                    <?php $__currentLoopData = $latestImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group relative aspect-square overflow-hidden rounded-lg shadow-md hover:shadow-xl transition gallery-image-container">
                            <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" alt="<?php echo e($image->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-300" loading="lazy" style="position: relative; z-index: 2;">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/0 to-black/0 opacity-0 group-hover:opacity-100 transition duration-300 flex items-end" style="position: relative; z-index: 3;">
                                <div class="p-4 text-white w-full">
                                    <h3 class="font-bold text-sm"><?php echo e($image->category ?: $image->title); ?></h3>
                                </div>
                            </div>
                            <!-- Small gallery title overlay -->
                            <div class="gallery-title-overlay">
                                <?php echo e($image->category ?: $image->title); ?>
                ...
                <div class="text-center mb-12">
                    ...
                    <?php if(config('app.debug')): ?>
                        <div class="text-center mb-4 text-sm text-gray-500">
                            Sponsors count: <?php echo e($sponsors->count()); ?>
                        ...
                        <div class="sponsor-slider flex items-center space-x-8 md:space-x-12">
                            <?php $__currentLoopData = $sponsors->concat($sponsors); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="sponsor-slide flex-shrink-0 px-4">
                                    <?php if($sponsor->logo): ?>
                                        <img src="<?php echo e(asset('storage/' . $sponsor->logo)); ?>" alt="<?php echo e($sponsor->name); ?>" class="max-h-24 w-auto hover:scale-110 transition-transform" loading="eager">
                                    <?php else: ?>
                                        <div class="text-gray-400 text-sm text-center px-8 py-4 bg-gray-100 rounded-lg min-w-[120px]"><?php echo e($sponsor->name); ?></div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
