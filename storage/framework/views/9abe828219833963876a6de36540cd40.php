    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between mb-6">
                ...
                <a href="<?php echo e(route('admin.news.create')); ?>" class="bg-yellow-400 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500">
                    Add News Article
                </a>
            </div>
                        ...
                        <tr>
                            <td class="px-6 py-4">
                                <?php if($article->featured_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $article->featured_image)); ?>" alt="<?php echo e($article->title); ?>" class="h-16 w-24 object-cover rounded">
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <?php if($article->excerpt): ?>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($article->excerpt, 50)); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-sm"><?php echo e($article->published_at ? $article->published_at->format('M d, Y') : 'N/A'); ?></td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 text-xs rounded-full <?php echo e($article->is_published ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    <?php echo e($article->is_published ? 'Published' : 'Draft'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <a href="<?php echo e(route('admin.news.edit', $article)); ?>" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
...
<?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/admin/news/index.blade.php ENDPATH**/ ?>