        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between mb-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="<?php echo e(route('admin.gallery.bulk-upload')); ?>" class="bg-yellow-500 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-600 flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                        </svg>
                        Bulk Upload
                    </a>
                    <a href="<?php echo e(route('admin.gallery.chunked-upload')); ?>" class="bg-blue-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-600 flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                        </svg>
                        Chunked Upload
                    </a>
                    <a href="<?php echo e(route('admin.gallery.create')); ?>" class="bg-yellow-400 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500">
                        Add Single Image
                    </a>
                </div>
            </div>

            <?php if($groupedImages->count() > 0): ?>
                <?php $__currentLoopData = $groupedImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleryTitle => $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Gallery Section -->
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-2xl font-bold text-gray-900 border-b-2 border-yellow-400 pb-2">
                                <?php echo e($galleryTitle); ?> (<?php echo e($images->count()); ?> images)
                            </h2>
                            <div class="flex items-center space-x-2">
                                <input type="checkbox" id="select-all-<?php echo e($loop->index); ?>" class="select-all-gallery" data-gallery="<?php echo e($loop->index); ?>">
                                <label for="select-all-<?php echo e($loop->index); ?>" class="text-sm text-gray-600">Select All</label>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            <div class="bg-white rounded-lg shadow overflow-hidden">
                                <div class="relative">
                                    <input type="checkbox" class="image-checkbox absolute top-2 left-2 z-10" value="<?php echo e($image->id); ?>" data-gallery="<?php echo e($loop->parent->index); ?>">
                                    <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" alt="<?php echo e($image->title); ?>" class="w-full h-48 object-cover cursor-pointer hover:opacity-90 transition" onclick="viewImage('<?php echo e(asset('storage/' . $image->image_path)); ?>', '<?php echo e($image->title); ?>', '<?php echo e($image->description ?? ''); ?>')">
                                </div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-900 mb-1"><?php echo e($image->title); ?></h3>
                                    <?php if($image->category): ?>
                                        <p class="text-xs text-gray-500 mb-2"><?php echo e($image->category); ?></p>
                                    <?php endif; ?>
                                    <?php if($image->is_featured): ?>
                                        <span class="inline-block px-2 py-1 text-xs bg-yellow-100 text-yellow-800 rounded-full mb-2">Featured</span>
                                    <?php endif; ?>
                                    <div class="flex space-x-2 mt-3">
                                        <button onclick="viewImage('<?php echo e(asset('storage/' . $image->image_path)); ?>', '<?php echo e($image->title); ?>', '<?php echo e($image->description ?? ''); ?>')" class="text-sm text-blue-600 hover:text-blue-900">View</button>
                                        <a href="<?php echo e(route('admin.gallery.edit', $image)); ?>" class="text-sm text-yellow-600 hover:text-yellow-900">Edit</a>
                                        <form action="<?php echo e(route('admin.gallery.destroy', $image)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
            ...
            <!-- Bulk Delete Form -->
            <form id="bulk-delete-form" action="<?php echo e(route('admin.gallery.bulk-delete')); ?>" method="POST" class="hidden">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Dhanushka\Desktop\YSSC\YSSCWEBv3\resources\views/admin/gallery/index.blade.php ENDPATH**/ ?>